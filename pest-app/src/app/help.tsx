...
export default function HelpPage() {
	return (
		<ScrollView className="flex-1 bg-white px-[5vw] py-6">
			...
			{/* How to Use */}
			<Text className="text-xl font-semibold mb-4">How to Analyze a Plant</Text>
			...
			<View className="gap-4 mb-8">
				...
				<View className="flex-row gap-3">
					<RefreshCw size={22} color="#15803d" />
					<Text className="flex-1 text-gray-700 leading-6">
			...
			{/* Troubleshooting */}
			<Text className="text-xl font-semibold mb-4">Common Issues</Text>
