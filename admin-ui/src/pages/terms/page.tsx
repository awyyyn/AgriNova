...
export const metadata = {
	...
	description: "Read our terms of service and conditions for using AgriNova.",
};
				...
				<div className="max-w-4xl mx-auto px-4 py-20 md:py-32">
					...
					<div className="space-y-8 text-gray-600 leading-relaxed">
						<div>
							...
							<p>
								By accessing and using AgriNova, you accept and agree to be
						...
						<div>
							...
							<p>
								...
								use or inability to use the materials on AgriNova, even if
								AgriNova or an authorized representative has been notified
						...
						<div>
							...
							<p>
								AgriNova may revise these terms of service for its website at
						...
						<div>
							...
							<p>
								...
								their account information and password and for restricting
								access to their computer. They agree to accept responsibility
								for all activities that occur under their account or password.
							</p>
						</div>
						...
						<div>
							...
							<p>
								AgriNova reserves the right to terminate your account and access
								to the service at any time, for any reason, without prior
								notice.
							</p>
						</div>
						...
						<div>
							...
							<p>
								...
								contact us at support@agrinova.com or visit our contact page.
							</p>
						</div>
					</div>
				</div>
