				...
				<div className="max-w-4xl mx-auto px-4 py-20 md:py-32">
					...
					<div className="space-y-8 text-gray-600 leading-relaxed">
						<div>
							...
							<p>
								AgriNova ("we", "our", or "us") operates the AgriNova website
						...
						<div>
							...
							<div className="space-y-4">
								<div>
									...
									<p>
										Email address, name, password, and profile information
								...
								<div>
									...
									<p>
										...
										visit, and other diagnostic data to help us understand how
										you use AgriNova.
									</p>
								</div>
								<div>
						...
						<div>
							...
							<p>
								...
								analysis history is stored in your account for your reference
						...
						<div>
							...
							<p>
								...
								account is active or as necessary to provide you services.
								Images processed for pest detection are typically deleted after
								30 days unless saved to your account history. You can request
						...
						<div>
							...
							<p>
								...
								information from children under 13, we take steps to delete such
						...
						<div>
							...
							<p>
								...
								may differ. We will ensure appropriate safeguards are in place
